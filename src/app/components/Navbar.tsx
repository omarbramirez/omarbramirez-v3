...
<div className='flex items-center gap-4'>
  <button>
    <Image src={assets.moon_icon} alt='night_mode' className='w-6'/>
  </button>
  <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-EB_Garamond'>{t('contact')}  <Image src={assets.arrow_icon} className='w-3' alt='arrow_icon'/></a>
